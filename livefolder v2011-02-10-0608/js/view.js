...
function setupSidebar()
{
	...
	showRoundStatus(createRoundStatusString());
	setupLeaderboard();
}
...
// 	var headerText = document.createTextNode('Current Leaders');
// 	leaderboardDiv.appendChild(headerText);
// 	
...
// 		newRow.setAttribute('class', 'leader');
// 		var newCell = document.createElement('td');
// 		newCell.appendChild(document.createTextNode(leaderBoard[i].displayName));
// 		newRow.appendChild(newCell);
// 		table.appendChild(newRow);
// 	}
// 	leaderboardDiv.appendChild(table);
// 	sidebar.appendChild(leaderboardDiv);
}
...
function setupMainMenu() {
	...
	if (((user.privileges & VIEW_PERMISSION) == VIEW_PERMISSION) && (user.surveyTaken == 0)) {
		...
		a1.href="javascript:setupSurvey()";
	...
	if (((user.privileges & VIEW_PERMISSION) == VIEW_PERMISSION) && userEligible() && !gameInProgress & (user.surveyTaken == 1)) {
		var mid1 = document.createTextNode(' [');
		var a1 = document.createElement('a');
...
// 	question 1:  gender
	...
	genderLegend.appendChild(document.createTextNode(q1text));
	genderFieldSet.appendChild(genderLegend);
	
	// create the male button
	genderFieldSet.appendChild(makeRadio('Male', 'gender', 'm', 'm'));

	// create the female button
	genderFieldSet.appendChild(makeRadio('Female', 'gender', 'f', 'f'));
	
	surveyform.appendChild(genderFieldSet);
	
// question 2 social media	
	
	q2FieldSet = document.createElement('fieldset');
	q2Legend = document.createElement('legend');
	q2Legend.appendChild(document.createTextNode(q2text));
	q2FieldSet.appendChild(q2Legend);
	
	// create the ans1 button
	for (i = 10; i <= 240; i=i+10)
	{
		q2FieldSet.appendChild(makeRadio(i, 'q2', 'q2a', ''+ i));
	}
	// // create the ans2 button
	// q2FieldSet.appendChild(makeRadio('20', 'q2', 'q2b', '20'));
	// 
	// // create the ans1 button
	// q2FieldSet.appendChild(makeRadio('30', 'q2', 'q2c', '30'));
	// 
	// // create the ans2 button
	// q2FieldSet.appendChild(makeRadio('40 or more', 'q2', 'q2d', '40'));
	
	surveyform.appendChild(q2FieldSet);
	
// question 3 	

		q3FieldSet = document.createElement('fieldset');
		q3Legend = document.createElement('legend');
		q3Legend.appendChild(document.createTextNode(q3text));
		q3FieldSet.appendChild(q3Legend);

		for (i = 10; i <= 240; i=i+10)
		{
			q3FieldSet.appendChild(makeRadio(i, 'q3', 'q3a', ''+ i));
		}
		// // create the ans1 button
		// q3FieldSet.appendChild(makeRadio('10', 'q3', 'q3a', '10'));
		// 
		// // create the ans2 button
		// q3FieldSet.appendChild(makeRadio('20', 'q3', 'q3b', '20'));
		// 
		// // create the ans1 button
		// q3FieldSet.appendChild(makeRadio('30', 'q3', 'q3c', '30'));
		// 
		// // create the ans2 button
		// q3FieldSet.appendChild(makeRadio('40 or more', 'q3', 'q3d', '40'));

		surveyform.appendChild(q3FieldSet);	
	
		// question 3 	

		q4FieldSet = document.createElement('fieldset');
		q4Legend = document.createElement('legend');
		q4Legend.appendChild(document.createTextNode(q4text));
		q4FieldSet.appendChild(q4Legend);

		for (i = 10; i <= 240; i=i+10)
		{
			q4FieldSet.appendChild(makeRadio(i, 'q4', 'q4a', ''+ i));
		}
		// // create the ans1 button
		// q4FieldSet.appendChild(makeRadio('10', 'q4', 'q4a', '10'));
		// 
		// // create the ans2 button
		// q4FieldSet.appendChild(makeRadio('20', 'q4', 'q4b', '20'));
		// 
		// // create the ans1 button
		// q4FieldSet.appendChild(makeRadio('30', 'q4', 'q4c', '30'));
		// 
		// // create the ans2 button
		// q4FieldSet.appendChild(makeRadio('40 or more', 'q4', 'q4d', '40'));

		surveyform.appendChild(q4FieldSet);	

		// question 5

		q5FieldSet = document.createElement('fieldset');
		q5Legend = document.createElement('legend');
		q5Legend.appendChild(document.createTextNode(q5text));
		q5FieldSet.appendChild(q5Legend);

	
		for (i = 10; i <= 240; i=i+10)
		{
			q5FieldSet.appendChild(makeRadio(i, 'q5', 'q5a', ''+ i));
		}
		// // create the ans1 button
		// q5FieldSet.appendChild(makeRadio('10', 'q5', 'q5a', '10'));
		// 
		// // create the ans2 button
		// q5FieldSet.appendChild(makeRadio('20', 'q5', 'q5b', '20'));
		// 
		// // create the ans1 button
		// q5FieldSet.appendChild(makeRadio('30', 'q5', 'q5c', '30'));
		// 
		// // create the ans2 button
		// q5FieldSet.appendChild(makeRadio('40 or more', 'q5', 'q5d', '40'));

		surveyform.appendChild(q5FieldSet);	

...
function setupSidebar()
{
	...
	if (gameInProgress)
	{
		...
		showRoundStatus('No game in progress.');
	}
	setupLeaderboard();
}
...
function setupRoundPanel()
{
	...
	roundform.setAttribute('class', 'contentChild');
	roundform.setAttribute('action', 'javascript:placeBet()');
	
	var messagediv=document.createElement("div");
	messagediv.setAttribute("id", "roundform");
...
function setupLeaderboard()
{
	...
	var headertextPar = document.createElement('p');
	headertextPar.setAttribute('class', 'nametext');
	headertextPar.innerHTML = "Game Leaders";
	leaderboardDiv.appendChild(headertextPar);
	...
	for (i = 0; i < leaderBoard.length; i++)
	{
		...
		{
			newRow.setAttribute('class', 'leaderalt');
		}
		var newCell = document.createElement('td');
		var leadertext = leaderBoard[i].displayName + " (" + leaderBoard[i].gamesPlayed + " games) : " + leaderBoard[i].money;
		var leadertextpar = document.createElement('p');
		leadertextpar.setAttribute('class', 'leadertext');
		leadertextpar.appendChild(document.createTextNode(leadertext));
		newCell.appendChild(leadertextpar);
...
function showAccountFunctions() {
	...
	infoform.setAttribute('class', 'contentChild');
...
function setUpIntroduction()
{
	...
	instructionsDiv.setAttribute('class', 'contentChild');
	instructionsDiv.setAttribute('id', 'instructionsDiv');
	contentPanel.appendChild(instructionsDiv);
	
	var instructionsDiv2 = document.getElementById('instructionsDiv');
	instructionsDiv2.innerHTML = introHTML;
}

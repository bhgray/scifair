...
var loginInstructionString = '<strong>Enter your username and password EXACTLY as instructed.  </strong><br />If this is your first time logging into the system, use the ID given to you (all upper case), and the password \"password\" (all lower case).';
...
var accountFunctionsInstructionString = '<p>You can change your display name or password here by typing in the appropriate information and pressing the \"Save Changes\" button.</p><p>To change your password, you need to type it twice before you press the button.</p>';
var surveyInstructionString = '<p>Please take this survey</p>';
var q1text = 'Gender:';
var q2text = 'I use social networking sites on the internet for this number of minutes each day.';
var q3text = 'I talk on the telephone for this number of minutes each day.';
var q4text = 'I text for this many number of minutes per day.';
var q5text = 'I play multiplayer video games for this many number of minutes per day.';
var thanksyousurveystring = 'Thank you!';